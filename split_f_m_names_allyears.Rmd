---
title: "Split F M Names All Years"
...
```
This code opens each YOB file per year and splits out the female names from the male names. Each file is saves as a separate CSV file names for the year and the following ending "_m_names_top1000.txt" or "_f_names_top1000.txt".
...
```
A excerpt of one of the year files showing both male names and female names is shown here.
```{r}
head(yob_file_m_1000,10)
head(yob_file_f_1000,10)
```
