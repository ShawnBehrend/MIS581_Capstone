---
title: "Plot the Ratio of Occurrences of GN Names verus All Names"
...
```
This code uses the ratios caluclated in each Years Per Decade summary table to create a plot of the Ratio of Occurrences of GN Names verus All Names, showing both females and males on th same plot.
```{r}
#load data files
